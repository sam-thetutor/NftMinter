export const idlFactory = ({ IDL }) => {
  ...
  const TransferRequest = IDL.Record({
    ...
    'amount' : Balance,
    'transfer_type' : IDL.Opt(TransactionType),
  });
  ...
  const EXTNFT = IDL.Service({
    ...
    'get_all_transfer_history' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(TokenIndex, IDL.Vec(TransactionEvent)))],
        ['query'],
      ),
    'get_token_transfer_history' : IDL.Func(
        [IDL.Nat32],
        [IDL.Vec(TransactionEvent)],
        ['query'],
      ),
